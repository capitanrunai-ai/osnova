export const serviceContent = {
  ru: {
    ...
    development: {
      label: '02 / РАЗРАБОТКА',
      title: 'Сайты и web-продукты',
      titleAccent: 'для бизнеса.',
      intro: 'Разрабатываем коммерческие сайты и web-решения вокруг конкретной задачи: от запуска одной услуги до продукта со своей логикой.',
      visual: ['ИНТЕРФЕЙС', 'ЛОГИКА', 'ДАННЫЕ'],
      principle: 'Для одной цели, для компании или для сложной логики — свой формат.',
      products: [
        ['01', 'Landing Pages', 'Для одной услуги, продукта или кампании: один сценарий и ясное действие.', 'Одна цель'],
        ['02', 'Корпоративные сайты', 'Для компании с несколькими услугами: разделы, содержание и путь к контакту.', 'Несколько услуг'],
        ['03', 'Web Applications', 'Для пользовательских сценариев и нестандартной бизнес-логики.', 'Функциональность'],
        ['04', 'Internal Tools', 'Для внутренних задач: панели управления, рабочие процессы и отчёты.', 'Операции'],
        ['05', 'MVP Development', 'Первая рабочая версия продукта для проверки реального сценария.', 'Проверка идеи'],
        ['06', 'Custom Software', 'Когда готового инструмента недостаточно: логика и интеграции под задачу.', 'Индивидуально'],
      ],
      landing: {
        label: 'БЫСТРЫЙ ЗАПУСК / ПО ОБЪЁМУ',
        title: 'Быстро, когда задача это позволяет.',
        text: 'Небольшой проект с ясным объёмом может выйти за несколько дней. Для сложного продукта сначала определяем функциональность и срок.',
        scopeLabel: 'ОЦЕНКА ПРОЕКТА',
        scope: 'Стоимость зависит от типа сайта, числа страниц, функций, интеграций, админ-панели, дизайна и контента.',
        team: 'Нужных специалистов подключаем под задачу.',
        art: ['СЛОЖНОЕ', 'СТАНОВИТСЯ', 'НЕИЗБЕЖНЫМ.'],
      },
      build: {
        label: 'КАК РАБОТАЕМ',
        steps: [
          ['Понять', 'Цель, аудитория, функциональность.'],
          ['Структурировать', 'Страницы, контент, путь пользователя.'],
          ['Создать', 'Дизайн, разработка, интеграции.'],
...
const en = {
  ...
  development: {
    label: '02 / DEVELOPMENT', title: 'Websites & web products', titleAccent: 'for business.',
    intro: 'We build commercial websites and web solutions around a specific goal, from launching one service to a product with its own logic.',
    visual: ['INTERFACE', 'LOGIC', 'DATA'],
    principle: 'One goal, a full business website or custom logic: each calls for a different format.',
    products: [
      ['01', 'Landing Pages', 'For one service, product or campaign: one clear journey and action.', 'One goal'],
      ['02', 'Corporate Websites', 'For a company with several services: pages, content and a path to contact.', 'Several services'],
      ['03', 'Web Applications', 'For user journeys and custom business logic.', 'Functionality'],
      ['04', 'Internal Tools', 'For internal work: admin panels, workflows and reports.', 'Operations'],
      ['05', 'MVP Development', 'A first working product version to test a real use case.', 'Idea validation'],
      ['06', 'Custom Software', 'When existing tools fall short: logic and integrations shaped to the job.', 'Custom scope'],
    ],
    landing: {
      label: 'FAST LAUNCH / WHEN SCOPE ALLOWS', title: 'Fast when the scope is clear.',
      text: 'A small, well-defined project can launch in days. For a more complex product, we scope the functionality and timeline first.',
      scopeLabel: 'PROJECT ESTIMATE',
      scope: 'Cost depends on site type, page count, functionality, integrations, admin features, design and content.',
      team: 'We bring in the specialists the project needs.',
      art: ['MAKE THE', 'COMPLEX', 'INEVITABLE.'],
    },
    build: { label: 'HOW WE WORK', steps: [
      ['Understand', 'Goal, audience and functionality.'],
      ['Structure', 'Pages, content and user flow.'],
...
serviceContent.de = replaceDeep(en, [
  ...
  ['Custom', 'Individuell'], ['Customer', 'Kunde'], ['Request', 'Anfrage'],
])
...
Object.assign(serviceContent.de.development, {
  ...
  titleAccent: 'für Unternehmen.',
  intro: 'Wir entwickeln kommerzielle Websites und Weblösungen für ein konkretes Ziel — vom Start einer Leistung bis zum Produkt mit eigener Logik.',
  visual: ['INTERFACE', 'LOGIK', 'DATEN'],
  principle: 'Ein Ziel, eine vollständige Unternehmenswebsite oder eigene Logik: Jedes Vorhaben braucht das passende Format.',
  products: [
    ['01', 'Landingpages', 'Für eine Leistung, ein Produkt oder eine Kampagne: ein klarer Weg zur Handlung.', 'Ein Ziel'],
    ['02', 'Unternehmens­websites', 'Für Unternehmen mit mehreren Leistungen: Seiten, Inhalte und Kontaktwege.', 'Mehrere Leistungen'],
    ['03', 'Web-Applikationen', 'Für Nutzerabläufe und individuelle Geschäftslogik.', 'Funktionen'],
    ['04', 'Interne Tools', 'Für interne Arbeit: Admin-Panels, Abläufe und Berichte.', 'Betrieb'],
    ['05', 'MVP-Entwicklung', 'Eine erste funktionsfähige Produktversion zum Testen eines realen Szenarios.', 'Idee prüfen'],
    ['06', 'Individuelle Software', 'Wenn Standardwerkzeuge nicht ausreichen: Logik und Integrationen nach Bedarf.', 'Individuell'],
  ],
  landing: {
    label: 'SCHNELLER START / JE NACH UMFANG', title: 'Schnell, wenn der Umfang klar ist.',
    text: 'Ein kleines, klar definiertes Projekt kann in wenigen Tagen online gehen. Bei komplexeren Produkten klären wir Funktionen und Zeitplan zuerst.',
    scopeLabel: 'PROJEKTSCHÄTZUNG',
    scope: 'Der Preis hängt von Website-Typ, Seitenzahl, Funktionen, Integrationen, Admin-Bereich, Design und Inhalten ab.',
    team: 'Wir stellen die passenden Fachleute für die Aufgabe zusammen.',
    art: ['KOMPLEXES', 'WIRD', 'KLAR.'],
  },
  build: { label: 'SO ARBEITEN WIR', steps: [
    ['Verstehen', 'Ziel, Zielgruppe und Funktionen.'],
    ['Strukturieren', 'Seiten, Inhalte und Nutzerführung.'],
...
serviceContent.uk = replaceDeep(serviceContent.ru, [
  ...
  ['Индивидуально', 'Індивідуально'], ['Клиент', 'Клієнт'], ['Анализ', 'Аналіз'],
])
...
Object.assign(serviceContent.uk.development, {
  label: '02 / РОЗРОБКА',
  title: 'Сайти та web-продукти',
  titleAccent: 'для бізнесу.',
  intro: 'Розробляємо комерційні сайти й web-рішення для конкретної мети: від запуску однієї послуги до продукту з власною логікою.',
  visual: ['ІНТЕРФЕЙС', 'ЛОГІКА', 'ДАНІ'],
  principle: 'Для однієї мети, для компанії чи для складної логіки — свій формат.',
  products: [
    ['01', 'Landing Pages', 'Для однієї послуги, продукту чи кампанії: один зрозумілий шлях до дії.', 'Одна мета'],
    ['02', 'Корпоративні сайти', 'Для компанії з кількома послугами: сторінки, зміст і шлях до контакту.', 'Кілька послуг'],
    ['03', 'Web Applications', 'Для сценаріїв користувача та нестандартної бізнес-логіки.', 'Функціональність'],
    ['04', 'Внутрішні інструменти', 'Для внутрішньої роботи: адмін-панелі, процеси та звіти.', 'Операції'],
    ['05', 'MVP Development', 'Перша робоча версія продукту для перевірки реального сценарію.', 'Перевірка ідеї'],
    ['06', 'Custom Software', 'Коли готового інструмента замало: логіка й інтеграції під завдання.', 'Індивідуально'],
  ],
  landing: {
    label: 'ШВИДКИЙ ЗАПУСК / ЗА ОБСЯГОМ', title: 'Швидко, коли обсяг зрозумілий.',
    text: 'Невеликий проєкт із чітким обсягом може вийти за кілька днів. Для складнішого продукту спершу визначаємо функції та термін.',
    scopeLabel: 'ОЦІНКА ПРОЄКТУ',
    scope: 'Вартість залежить від типу сайту, кількості сторінок, функцій, інтеграцій, адмін-панелі, дизайну й контенту.',
    team: 'Потрібних фахівців залучаємо під завдання.',
    art: ['СКЛАДНЕ', 'СТАЄ', 'НЕМИНУЧИМ.'],
  },
  build: { label: 'ЯК ПРАЦЮЄМО', steps: [
    ['Зрозуміти', 'Мета, аудиторія, функціональність.'],
    ['Структурувати', 'Сторінки, контент, шлях користувача.'],
