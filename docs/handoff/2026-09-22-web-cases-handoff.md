...
| --- | --- | --- | --- |
| DDS SERVICE | Понятно показать автосервис, направления ремонта и обслуживания, дать путь к нужной услуге или контакту. | Структура информации, представление услуг, путь пользователя, адаптивная разработка; рабочий сайт опубликован. | Примерно 23 дня. |
